...
export default function PixelCard({ variant = 'default', gap, speed, colors, noFocus, className = '', children }) {
  ...
  const reducedMotion = useRef(false); // Can be linked to window.matchMedia
  ...
  return (
    ...
    >
      <canvas className="pixel-canvas absolute inset-0 z-0 opacity-40 mix-blend-screen" ref={canvasRef} />
